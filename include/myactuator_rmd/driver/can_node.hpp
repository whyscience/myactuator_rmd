...
namespace myactuator_rmd {
  ...
  */
  ...
  inline void printSendInfo(std::uint32_t const can_send_id, std::array<std::uint8_t,8> const& data) {
    Serial.print("sendRecv ID: ");
    Serial.print(can_send_id, HEX);
    Serial.print(", Data: ");
